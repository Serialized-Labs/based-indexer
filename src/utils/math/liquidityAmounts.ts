...
export function getAmount0(tickLower: bigint, tickUpper: bigint, currTick: bigint, amount: bigint, currSqrtPriceX96: bigint): bigint {
...
export function getAmount1(tickLower: bigint, tickUpper: bigint, currTick: bigint, amount: bigint, currSqrtPriceX96: bigint): bigint {
    const sqrtRatioAX96 = TickMath.getSqrtRatioAtTick(tickLower);
    const sqrtRatioBX96 = TickMath.getSqrtRatioAtTick(tickUpper);
